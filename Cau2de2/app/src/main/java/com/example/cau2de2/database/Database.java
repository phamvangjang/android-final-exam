package com.example.cau2de2.database;
...
public class Database extends SQLiteOpenHelper {
    ...
    public void createSampleData(){
        if(getNumbOfRows()==0){
            try{
                execSql(" INSERT INTO " + TBL_NAME + " VALUES('SP-122', 'Vertu Constellation', 10000)");
                execSql(" INSERT INTO " + TBL_NAME + " VALUES('SP-123', 'IPhone 5S', 15000)");
                execSql(" INSERT INTO " + TBL_NAME + " VALUES('SP-124', 'Nokia Lumia 925', 17000)");
                execSql(" INSERT INTO " + TBL_NAME + " VALUES('SP-125', 'SamSung Galaxy S4', 19000)");
                execSql(" INSERT INTO " + TBL_NAME + " VALUES('SP-126', 'HTC Desire 500', 11000)");
                execSql(" INSERT INTO " + TBL_NAME + " VALUES('SP-127', 'HKPhone Revo LEAD', 21000)");
            }catch (Exception e){
