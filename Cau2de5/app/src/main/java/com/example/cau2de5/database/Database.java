package com.example.cau2de5.database;
...
public class Database extends SQLiteOpenHelper {
    public static final String DB_NAME = "db_book.sqlite";
    ...
    public void createSampleData(){
        if (getNumbOfRows()==0){
            try{
                execSql(" INSERT INTO " + TBL_NAME + " VALUES('MS-101', 'Cau truc du lieu vs gt', 20000)");
                execSql(" INSERT INTO " + TBL_NAME + " VALUES('MS-102', 'Cong nghe java', 30000)");
                execSql(" INSERT INTO " + TBL_NAME + " VALUES('MS-103', 'Lap trinh web', 25000)");
                execSql(" INSERT INTO " + TBL_NAME + " VALUES('MS-104', 'Co so du lieu',  15000)");
                execSql(" INSERT INTO " + TBL_NAME + " VALUES('MS-105', 'Tri tue nhan tao',  29000)");
                execSql(" INSERT INTO " + TBL_NAME + " VALUES('MS-106', 'lap trinh truc quan', 21000)");
            }catch (Exception e){
